...
import { getEntities as getBlogEntries } from 'app/entities/blog-entry/blog-entry.reducer';
...
export class TagUpdate extends React.Component<ITagUpdateProps, ITagUpdateState> {
  ...
  render() {
    const { tagEntity, blogEntries, loading, updating } = this.props;
...
const mapStateToProps = (storeState: IRootState) => ({
  blogEntries: storeState.blogEntry.entities,
